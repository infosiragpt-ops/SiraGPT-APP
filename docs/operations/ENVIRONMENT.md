...
| `SIRA_MINI_UPSTREAM_ID` | Ollama id for SiraGPT Mini chat completions. Default: `sira-mini`. Lenovo Ollama Mini = `sira-mini` → `gemma4:26b`, `num_ctx` 8192. The picker always shows **SiraGPT Mini**. |
