...
Status: Phase 4c of `AGENTES_CODING_V2` (flag-gated TypeScript harness
+ HITL + durable jobs). Phase 1 = docs + flag; Phase 2a =
...
Phase 4b = HITL; Phase 4c = durable jobs.
...
The harness (**Phase 4a + 4b + 4c landed**, API-only stub) sits **inside** the
