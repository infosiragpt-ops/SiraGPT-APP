...
Status: Phase 4b of `AGENTES_CODING_V2` (flag-gated TypeScript harness
+ HITL permission gates). Phase 1 = docs + flag; Phase 2a =
...
The harness (**Phase 4a + 4b landed**, API-only stub) sits **inside** the
