...
UI sin cambios en 3H60, hot-path #399, 3H61, 3H62, 3H63, 3H64, 3H65 ni 3H66 (Empresas lock, RunTrace assistant-only, loaders celeste). `/code` computer solo pasa `conversationId` (cero chrome). DeepSeek Flash/Pro only.
