...
| **F7** | SiraComputer (multimodal + desktop VM) | Visión en el loop, voz, y computer-use sobre un `DesktopProvider` híbrido. **F7.0–F7.4 COMPLETED**. Spec: `F7_SIRACOMPUTER_MASTER_SPEC.md`. El orquestador live se CONSERVA. ORM = Prisma. | F7.0–F7.8 | F7.0–F7.4 ✅. F7.5+ no iniciada |
...
| **F7.4** | Handoff FSM (login/captcha; HARD leak gate) | **COMPLETED** (CI `desktop-f74`) |
