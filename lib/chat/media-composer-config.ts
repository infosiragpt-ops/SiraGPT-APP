...
export type MusicModel = "Suno V4" | "Suno V3.5" | "MiniMax" | "ElevenLabs" | "Lyria 3 Pro"
...
export const MUSIC_MODEL_OPTIONS: readonly MusicModel[] = ["Suno V4", "Suno V3.5", "MiniMax", "ElevenLabs", "Lyria 3 Pro"]
