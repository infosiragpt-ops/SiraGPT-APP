...
export type AgentTaskEvent =
  | { type: "meta"; taskId?: string; goal: string; model: string; tools: string[]; executionProfile?: Record<string, unknown>; intentAlignmentProfile?: Record<string, unknown> }
...
export interface AgentTaskState {
  meta?: { taskId?: string; goal: string; model: string; tools: string[]; executionProfile?: Record<string, unknown>; intentAlignmentProfile?: Record<string, unknown> }
  steps: Array<{
    id: string
    label: string
    icon?: AgenticIcon
