...
describe("GPTs Apps catalog", () => {
  it("keeps unique connectable apps and drops synthetic drafts", () => {
    ...
    assert.match(catalog, /id: "onedrive"/)
    assert.match(catalog, /id: "google-drive"/)
    ...
    assert.match(catalog, /domain: "onedrive.live.com"/)
    assert.match(catalog, /domain: "drive.google.com"/)
