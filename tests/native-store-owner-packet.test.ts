...
describe("generate-native-store-owner-packet", () => {
  it("creates a non-secret store owner packet with zip and checksum", () => {
    ...
    try {
      ...
      assert.equal(summary.latestSignedPreflight.run, "28733337158")
      assert.equal(summary.latestSignedPreflight.sourceSha, "7d0d47cfb3c79d3d075037d2560340877e5bf0be")
      ...
      assert.equal(manifest.latestSignedPreflight.run, "28733337158")
      assert.equal(manifest.latestSignedPreflight.sourceSha, "7d0d47cfb3c79d3d075037d2560340877e5bf0be")
