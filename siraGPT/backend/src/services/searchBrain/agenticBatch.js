...
// Default academic pool for the agentic batcher. Premium indexes
// (Web of Science, Scopus) sit first when their keys/entitlements are
// present; each provider soft-skips to [] when no key is configured,
// and the rest of the pool carries the run.
const DEFAULT_PROVIDERS = ["wos", "scopus", "openalex", "scielo", "semantic", "crossref", "pubmed", "doaj"];
