...
test("modern office city renders a moving day and night environment", async ({ page }, testInfo) => {
  ...
  await expect.poll(async () => Number(await canvas.getAttribute("data-city-building-count"))).toBeGreaterThanOrEqual(70)
  ...
  await expect.poll(async () => Number(await canvas.getAttribute("data-city-glass-facade-count"))).toBeGreaterThanOrEqual(500)
  await expect.poll(async () => Number(await canvas.getAttribute("data-city-terrace-amenity-count"))).toBeGreaterThanOrEqual(18)
  await expect.poll(async () => Number(await canvas.getAttribute("data-city-tallest-building-height"))).toBeGreaterThanOrEqual(460)
...
test("desktop company panel shows real Matrix-style operations", async ({ page }, testInfo) => {
  ...
  await expect.poll(async () => Number(await officeThumbnail.locator("canvas").getAttribute("data-city-building-count"))).toBeGreaterThanOrEqual(25)
  await expect.poll(async () => Number(await officeThumbnail.locator("canvas").getAttribute("data-city-glass-facade-count"))).toBeGreaterThanOrEqual(100)
  ...
  await expect.poll(async () => Number(await officeCanvas.getAttribute("data-city-building-count"))).toBeGreaterThanOrEqual(70)
  ...
  await expect.poll(async () => Number(await officeCanvas.getAttribute("data-city-glass-facade-count"))).toBeGreaterThanOrEqual(500)
  await expect.poll(async () => Number(await officeCanvas.getAttribute("data-city-terrace-amenity-count"))).toBeGreaterThanOrEqual(15)
  await expect.poll(async () => Number(await officeCanvas.getAttribute("data-city-tallest-building-height"))).toBeGreaterThanOrEqual(460)
