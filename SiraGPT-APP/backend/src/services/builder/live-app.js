...
function buildShowcaseLanding(brief) {
  ...
  return [
    ...
    '<main>',
    '<div id="inicio" class="hero"><section><span class="eyebrow">' + escapeHtml(cfg.eyebrow) + '</span><h1>' + title + '</h1><p class="lead">' + lead + '</p><div class="actions"><a class="btn" href="#contacto">' + escapeHtml(cfg.primaryCta) + '</a><a class="btn secondary" href="#inventario">' + escapeHtml(cfg.secondaryCta) + '</a></div><div class="stats">' + stats + '</div></section><aside class="media"><img alt="' + title + '" src="' + escapeHtml(cfg.image) + '"><div class="media-card"><h2>' + escapeHtml(brief.purpose || cfg.eyebrow) + '</h2><p>Diseño responsive, visual y listo para seguir editando desde el chat.</p></div></aside></div>',
