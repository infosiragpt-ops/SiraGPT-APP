...
export function buildAppsModePrompt(userText: string): string {
  return [
    APPS_MODE_MARKER,
    "OBJETIVO: entregar software ejecutable y verificado a nivel de producto serio (calidad Claude Code / Cursor / Codex / ChatGPT Apps), no un mock visual ni un esqueleto vacío.",
    "",
    ...
    "",
    "BLUEPRINTS DE PRODUCTO POTENTE (elige el más cercano y complétalo):",
    "- Asistente tipo ChatGPT/Claude: chat streaming (adapter), historial, hilos, memoria, adjuntos, modelos seleccionables (mock providers si no hay keys), sidebar de conversaciones, settings, auth light, rate limits, admin básico, seeds y estados vacíos.",
    "- SaaS B2B (CRM/ERP/ops): sidebar multi-módulo, dashboard KPIs, CRUD real, roles, auditoría, búsqueda/filtros, export, notificaciones y datos demo del dominio.",
    "- Marketplace / POS / inventario: catálogo, carrito o stock, movimientos, cobros o alertas, historial y cierre del día.",
    "- Centro de soporte: inbox, tickets, SLA, base de conocimiento, respuestas asistidas, métricas.",
    "- Si pide 'como Claude/ChatGPT/Cursor': NO copies marca ni UI exacta; replica CAPACIDADES (calidad, profundidad, multi-capa) con identidad propia SiraGPT.",
    "",
    "FÁBRICA DE SOFTWARE (cuando la instrucción es ambiciosa o corta):",
    "- Interpreta 'como ChatGPT/Claude/Cursor' como producto multi-módulo con: onboarding, chat/core, biblioteca, settings, admin, billing light (mock), y al menos un módulo de valor (archivos, GPTs, o proyectos).",
    "- Prioriza un vertical usable en los primeros 20–30 pasos; luego expande módulos en oleadas sin romper lo verde.",
    "- Cada oleada termina con typecheck + health API + un flujo de UI verificado en preview antes de la siguiente.",
    "- Mantén un SIRA.md vivo con visión, arquitectura, módulos y riesgos; actualízalo al cerrar cada oleada.",
    "",
    "COMPILA TODAS LAS CAPAS (orden obligatorio, una misión continua — no dejes capas a medias):",
    ...
    "",
    "BUCLE AUTÓNOMO OBLIGATORIO (puede durar horas):",
    ...
    "7. Si el presupuesto lo permite, añade un segundo y tercer módulo del dominio sin regresar a mocks.",
    "",
    "REGLAS DE AUTONOMÍA:",
    ...
    "- Prioriza profundidad: mejor 3 módulos reales cableados que 10 pantallas vacías.",
    "",
