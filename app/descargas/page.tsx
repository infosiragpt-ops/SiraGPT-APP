    ...
    <div className="min-h-screen bg-white text-neutral-950 dark:bg-neutral-950 dark:text-white">
      <main className="mx-auto w-full max-w-5xl px-5 py-12 md:px-8 md:py-16">
        ...
        <header className="mt-8 max-w-2xl">
          <p className="text-xs font-semibold uppercase text-neutral-500">iPhone, Android, Mac y Windows</p>
          <h1 className="mt-3 text-3xl font-bold md:text-4xl">SiraGPT en tu teléfono y computadora</h1>
