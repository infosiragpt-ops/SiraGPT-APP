    ...
    <div className="flex min-h-[50vh] items-center justify-center p-4">
      <div className="mx-auto max-w-md rounded-xl border border-border/60 bg-card p-6 text-center shadow-lg">
        ...
        <p className="mb-4 text-sm text-muted-foreground">
          Ocurrió un error al mostrar /code. Reintentar remonta el workspace
          en la misma URL. El chat no se ve afectado.
        </p>
        {error.digest ? (
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <Button type="button" variant="outline" size="sm" onClick={() => { window.location.href = "/code" }}>
