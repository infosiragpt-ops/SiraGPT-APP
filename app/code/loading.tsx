...
export default function Loading() {
  return (
    <div className="flex h-screen min-w-0 flex-col overflow-hidden bg-background text-foreground" role="status" aria-live="polite" aria-label="Cargando el espacio de código">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 md:grid-cols-[220px_360px_1fr]">
        <div className="hidden border-r border-border/60 p-3 space-y-2 md:block">
