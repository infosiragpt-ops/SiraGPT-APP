...
const docArtifactEditorRoutes = require('./src/routes/doc-artifact-editor');
...
app.use('/api/doc-artifact-editor', expensiveLimiter);
...
app.use('/api/doc-artifact-editor', docArtifactEditorRoutes);
