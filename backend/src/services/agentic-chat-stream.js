        ...
        if (isSourcePreservingEditRequest(userQuery, preloopFileIds)) {
          ...
          const artifactEvents = validatedResults
            .map((item) => ({
              ...
              previewHtml: (item.artifact.format === 'docx' || item.artifact.format === 'doc' || item.format === 'docx' || item.format === 'doc') ? null : (item.previewHtml || null),
              previewPdfUrl: item.previewPdfUrl || item.artifact?.previewPdfUrl || null,
    ...
    function onEvent(evt) {
      ...
      try {
        ...
        state.artifacts.push({
          ...
          previewHtml: (a.format === 'docx' || a.format === 'doc') ? null : (a.previewHtml || null),
          previewPdfUrl: a.previewPdfUrl || null,
