 ...
 *
 *   - providers (OpenAlex, Semantic Scholar, CrossRef, PubMed, DOAJ)
 ...
 *   - Redis fast-path
 *   - Redalyc scraping, arXiv Atom XML, Scopus / WoS Puppeteer
...
/**
 * @typedef {"openalex" | "semantic" | "crossref" | "pubmed" | "doaj"} SearchBrainSource
 *
...
const DEFAULT_ACADEMIC_SOURCES = ["openalex", "semantic", "crossref", "pubmed", "doaj"];
