...
function buildSystemPrompt({
  ...
  const lines = [
    ...
    'Si el proyecto viene de un repositorio de GitHub y publicaste (o el usuario menciona) un pull request, usa github_checks para leer el estado real del CI de esa rama o PR antes de afirmar que "todo pasa"; si hay checks en rojo, lee los pasos fallidos que devuelve, corrige la causa y vuelve a publicar.',
