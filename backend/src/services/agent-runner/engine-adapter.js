 ...
 * 3H58 extends (does not smash) 3H46: fail-open helpers in engine-3h58.js
 * (open-todo finish refuse, assistant-hash cut, +JSON repair, 504 backoff,
 * subagent deadline/steps, pgvector norm, dirty-path rollback refuse,
 * ---/+++ diffs, sandbox host-path/uid, SSE writer-gen, 409/ETIMEDOUT).
...
function load3h58() {
  try { return require('./engine-3h58'); } catch (_) { return {}; }
}
const h58 = load3h58();
...
module.exports = {
  ...
  refuseFinishIfPlanHasOpenTodos: h58.refuseFinishIfPlanHasOpenTodos,
  cutLoopIfSameAssistantContentHashTwice: h58.cutLoopIfSameAssistantContentHashTwice,
  stopIfMaxEmptyAssistantTurns: h58.stopIfMaxEmptyAssistantTurns,
  refuseToolCallIfMissingCallIdAndName: h58.refuseToolCallIfMissingCallIdAndName,
  repairJsonPlusPrefixedOnce: h58.repairJsonPlusPrefixedOnce,
  coerceEmailStringOrRefuse: h58.coerceEmailStringOrRefuse,
  backoffOn504GatewayTimeout: h58.backoffOn504GatewayTimeout,
  refuseToolIfUnknownEnumAfterRepair: h58.refuseToolIfUnknownEnumAfterRepair,
  stripZeroWidthFromToolName: h58.stripZeroWidthFromToolName,
  inheritSubagentMaxStepsFromParent: h58.inheritSubagentMaxStepsFromParent,
  cutSubagentIfParentDeadlinePassed: h58.cutSubagentIfParentDeadlinePassed,
  refuseSubagentIfParentTokensExhausted: h58.refuseSubagentIfParentTokensExhausted,
  capSubagentStdoutBytes16KiB: h58.capSubagentStdoutBytes16KiB,
  compactDropOrphanToolMessages: h58.compactDropOrphanToolMessages,
  rejectPgvectorNonFiniteNorm: h58.rejectPgvectorNonFiniteNorm,
  pinFactsWhenAccessCountAtLeast: h58.pinFactsWhenAccessCountAtLeast,
  dropMemoryHitsWithEmptyVector: h58.dropMemoryHitsWithEmptyVector,
  refuseRollbackIfByteLengthMismatch: h58.refuseRollbackIfByteLengthMismatch,
  checkpointKeepFailedAttemptsLastN: h58.checkpointKeepFailedAttemptsLastN,
  refuseRollbackIfUnrelatedDirtyPaths: h58.refuseRollbackIfUnrelatedDirtyPaths,
  refuseDiffMissingFromToFileHeaders: h58.refuseDiffMissingFromToFileHeaders,
  verifyReadAfterWriteSha256Prefix: h58.verifyReadAfterWriteSha256Prefix,
  refusePatchIfRenameMissingDelete: h58.refusePatchIfRenameMissingDelete,
  requireExactHunkStartLine: h58.requireExactHunkStartLine,
  capSandboxCombinedStreamBytes: h58.capSandboxCombinedStreamBytes,
  refuseSandboxEnvHostPathLeak: h58.refuseSandboxEnvHostPathLeak,
  requireSandboxNonRootUid: h58.requireSandboxNonRootUid,
  resumeReplaySkipIdsOutsideRingWindow: h58.resumeReplaySkipIdsOutsideRingWindow,
  rejectResumeIfWriterGenerationMismatch: h58.rejectResumeIfWriterGenerationMismatch,
  dropHeartbeatIfSeqUnchanged: h58.dropHeartbeatIfSeqUnchanged,
  heartbeatStampServerNowMs: h58.heartbeatStampServerNowMs,
  rejectEnqueueIfDuplicateRequestId: h58.rejectEnqueueIfDuplicateRequestId,
  demoteQueueIfWaitedOverHardCap: h58.demoteQueueIfWaitedOverHardCap,
  neverChargeIfStreamNeverOpenedAndCancelled: h58.neverChargeIfStreamNeverOpenedAndCancelled,
  settleCreditsOnlyAfterDoneEvent: h58.settleCreditsOnlyAfterDoneEvent,
  refundIfPromptTokensExceedHardCap: h58.refundIfPromptTokensExceedHardCap,
  classifyEtimedoutAsTimeout: h58.classifyEtimedoutAsTimeout,
  neverRetry409Conflict: h58.neverRetry409Conflict,
  latencyHintWhenStepP99OverBudget: h58.latencyHintWhenStepP99OverBudget,
  recordTurnLatencySampleP50: h58.recordTurnLatencySampleP50,
  TOOL_NAME_ALLOWLIST,
  MODEL_TIMEOUT_MS,
  MODEL_TTFB_MS,
  TOOL_RESULT_CAP,
