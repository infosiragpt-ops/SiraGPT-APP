...
const CATALOG = [
  {
    id: "openai/gpt-5.5", provider: "openrouter", family: "gpt-5",
    capabilities: { reasoning: 0.97, code: 0.95, tools: 0.95, vision: 0.94, long_context: 0.92 },
  ...
  {
    id: "anthropic/claude-opus-4.7", provider: "openrouter", family: "claude-opus",
    capabilities: { reasoning: 0.96, code: 0.92, tools: 0.9, vision: 0.9, long_context: 0.92 },
    cost_tier: "high", latency_tier: "normal",
  ...
  {
    id: "google/gemini-3.5", provider: "openrouter", family: "gemini-3",
    capabilities: { reasoning: 0.92, code: 0.9, tools: 0.88, vision: 0.95, long_context: 0.97 },
    cost_tier: "medium", latency_tier: "normal",
    context_window: 2_000_000, max_output: 32_000,
    supports_structured_outputs: true, supports_streaming: true,
    supports_caching: true,
    languages: ["en", "es", "fr", "de", "pt", "it", "ja", "zh", "ko", "ar"],
    plans: ["FREE", "PRO", "ENTERPRISE"],
  ...
  {
    id: "z-ai/glm-5.1", provider: "openrouter", family: "z-ai",
    capabilities: { reasoning: 0.86, code: 0.84, tools: 0.82, vision: 0.76, long_context: 0.88 },
  ...
  {
    id: "deepseek-v4-flash", provider: "deepseek", family: "deepseek-v4",
    capabilities: { reasoning: 0.82, code: 0.86, tools: 0.82, vision: 0.45, long_context: 0.94 },
    cost_tier: "low", latency_tier: "fast",
