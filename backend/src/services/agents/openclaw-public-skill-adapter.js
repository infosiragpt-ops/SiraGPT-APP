...
const PUBLIC_SKILL_ADAPTATIONS = Object.freeze({
  ...
  'openai-whisper': native('covered', ['audio_transcribe'], ['backend/src/skills/audio_transcribe', 'backend/src/services/audio-transcriber.js'], 'SiraGPT exposes owner-scoped speech-to-text through a native agent skill and provider policy.'),
  'openai-whisper-api': native('covered', ['audio_transcribe'], ['backend/src/skills/audio_transcribe', 'backend/src/services/audio-transcriber.js'], 'Cloud transcription uses the same bounded, owner-scoped SiraGPT skill contract.'),
  ...
  songsee: native('covered', ['audio_spectrogram'], ['backend/src/skills/audio_spectrogram', 'backend/src/services/agents/media-inspection-runtime.js'], 'SiraGPT creates bounded deterministic spectrogram artifacts from owner-scoped media.'),
  ...
  'video-frames': native('covered', ['video_frames'], ['backend/src/skills/video_frames', 'backend/src/services/agents/media-inspection-runtime.js'], 'SiraGPT extracts bounded frame artifacts from owner-scoped video files without shell access.'),
