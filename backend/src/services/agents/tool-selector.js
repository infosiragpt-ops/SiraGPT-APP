...
const CATEGORY_PATTERNS = Object.freeze({
  ...
  code: /(python_exec|host_bash|host_file|list_dir|glob_files|code_grep|clone_project|run_tests|propose_patch|static_check|check_ci|monitor_ci|search_code|get_symbol|project_read|project_write|project_exec|construir_scaffold|github_publish_project|github_open_repo|github_repo_|github_open_pull_request)/,
