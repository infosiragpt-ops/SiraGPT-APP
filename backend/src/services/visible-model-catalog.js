...
const VISIBLE_TEXT_MODEL_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    type: 'TEXT',
    icon: 'ClaudeLogo',
    description: 'Claude 3.5 Sonnet de Anthropic: razonamiento equilibrado, escritura y codigo.',
  ...
  },
  {
    ...
    aliases: ['llama-3.1-70b', 'llama-3.1-70b-instruct', 'meta-llama/llama-3.1-70b-instruct'],
  },
  {
    name: 'llama-3.3-70b',
  ...
  },
  {
    ...
    type: 'TEXT',
    icon: 'Sparkles',
    description: 'Qwen 2.5 72B via OpenRouter: razonamiento, codigo y contexto largo.',
    aliases: ['qwen-2.5-72b', 'qwen-2.5-72b-instruct', 'qwen/qwen-2.5-72b-instruct'],
  },
  {
    name: 'o3-mini',
    displayName: 'o3 Mini',
  ...
  },
  {
    ...
    aliases: ['gemma-3-27b', 'gemma-3-27b-it', 'google/gemma-3-27b-it'],
  },
  {
    name: 'command-r-plus',
