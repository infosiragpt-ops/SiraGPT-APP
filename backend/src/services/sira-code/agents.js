...
const AGENTS = Object.freeze({
  construir: Object.freeze({
    ...
    systemPrompt: [
      ...
      'Puedes leer, editar, buscar, consultar diagnósticos y ejecutar comandos allowlisted en el sandbox (sin red salvo permiso explícito).',
  ...
  planificar: Object.freeze({
    ...
    systemPrompt: [
      ...
      'Solo puedes leer, buscar y consultar diagnósticos. No escribas ni edites archivos.',
