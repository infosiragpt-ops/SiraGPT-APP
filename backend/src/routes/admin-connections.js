...
const KNOWN_PROVIDERS = new Set([
  ...
  'minimax',
  'suno',
  // Web search engines for the agents' Búsqueda rápida.
  'perplexity',
  'brave',
  'tavily',
  'exa',
...
const DEFAULT_PROVIDER_LABELS = {
  ...
  perplexity: 'Perplexity Search API (búsqueda rápida)',
  brave: 'Brave Search API (búsqueda web)',
  tavily: 'Tavily Search API (búsqueda web)',
  exa: 'Exa Search API (búsqueda web)',
  ollama: 'Ollama (local)',
