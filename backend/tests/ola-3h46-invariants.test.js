...
test('3H46-AD-001 snapshot keeps 3H45 flags and wave 3H46 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H46' || s.wave === '3H47' || s.wave === '3H48' || s.wave === '3H49' || s.wave === '3H50');
...
test('3H46-AH-001 compose binds 3H46 tests and wave is 3H46', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H46' || ad.adapterSnapshot().wave === '3H47' || ad.adapterSnapshot().wave === '3H48' || ad.adapterSnapshot().wave === '3H49' || ad.adapterSnapshot().wave === '3H50');
