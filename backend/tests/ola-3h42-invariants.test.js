...
test('3H42-AB-001 snapshot keeps 3H41 flags and wave 3H42 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H42' || s.wave === '3H43' || s.wave === '3H44' || s.wave === '3H45');
...
test('3H42-AF-001 compose binds 3H42 tests and wave is 3H42', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H42' || ad.adapterSnapshot().wave === '3H43' || ad.adapterSnapshot().wave === '3H44' || ad.adapterSnapshot().wave === '3H45');
