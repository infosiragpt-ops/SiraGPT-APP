...
test('3H43-AE-001 snapshot keeps 3H42 flags and wave 3H43 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H43' || s.wave === '3H44' || s.wave === '3H45' || s.wave === '3H46' || s.wave === '3H47');
...
test('3H43-AI-001 compose binds 3H43 tests and wave is 3H43', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H43' || ad.adapterSnapshot().wave === '3H44' || ad.adapterSnapshot().wave === '3H45' || ad.adapterSnapshot().wave === '3H46' || ad.adapterSnapshot().wave === '3H47');
