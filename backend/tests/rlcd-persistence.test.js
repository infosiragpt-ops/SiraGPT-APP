...
test('config.describe: single reviewable place, env overrides are flagged', () => {
  ...
  assert.deepEqual(Object.keys(d.kinds), ['intent_triage', 'execution_lane', 'model_route', 'compute_mode', 'media_intent', 'tool_risk', 'skill_route', 'rag_filter', 'web_search_intent', 'web_search_filter']);
