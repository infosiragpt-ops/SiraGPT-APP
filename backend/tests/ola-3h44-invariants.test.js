...
test('3H44-AE-001 snapshot keeps 3H43 flags and wave 3H44 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H44' || s.wave === '3H45' || s.wave === '3H46' || s.wave === '3H47' || s.wave === '3H48' || s.wave === '3H49' || s.wave === '3H50');
...
test('3H44-AI-001 compose binds 3H44 tests and wave is 3H44', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H44' || ad.adapterSnapshot().wave === '3H45' || ad.adapterSnapshot().wave === '3H46' || ad.adapterSnapshot().wave === '3H47' || ad.adapterSnapshot().wave === '3H48' || ad.adapterSnapshot().wave === '3H49' || ad.adapterSnapshot().wave === '3H50');
