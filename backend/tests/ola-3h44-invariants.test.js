...
test('3H44-AI-001 compose binds 3H44 tests and wave is 3H44', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H44' || ad.adapterSnapshot().wave === '3H45' || ad.adapterSnapshot().wave === '3H46' || ad.adapterSnapshot().wave === '3H59' || ad.adapterSnapshot().wave === '3H60');
