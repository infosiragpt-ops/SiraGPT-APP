...
test('3H40-X-001 snapshot keeps 3H39 flags true and wave 3H40 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H40' || s.wave === '3H41' || s.wave === '3H42' || s.wave === '3H43');
...
test('3H40-AC-001 compose binds 3H40 tests and wave is 3H40', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H40' || ad.adapterSnapshot().wave === '3H41' || ad.adapterSnapshot().wave === '3H42' || ad.adapterSnapshot().wave === '3H43');
});
