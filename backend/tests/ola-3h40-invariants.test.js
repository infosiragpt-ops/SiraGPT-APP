...
test('3H40-X-001 snapshot keeps 3H39 flags true and wave 3H40 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H40' || s.wave === '3H41' || s.wave === '3H42' || s.wave === '3H43' || s.wave === '3H44' || s.wave === '3H45' || s.wave === '3H46' || s.wave === '3H47' || s.wave === '3H48' || s.wave === '3H49');
...
test('3H40-AC-001 compose binds 3H40 tests and wave is 3H40', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H40' || ad.adapterSnapshot().wave === '3H41' || ad.adapterSnapshot().wave === '3H42' || ad.adapterSnapshot().wave === '3H43' || ad.adapterSnapshot().wave === '3H44' || ad.adapterSnapshot().wave === '3H45' || ad.adapterSnapshot().wave === '3H46' || ad.adapterSnapshot().wave === '3H47' || ad.adapterSnapshot().wave === '3H48' || ad.adapterSnapshot().wave === '3H49');
});
