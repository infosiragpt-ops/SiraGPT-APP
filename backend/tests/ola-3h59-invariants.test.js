...
test('3H59-P-001 adapter fail-open wires 3H59 helpers and wave', () => {
  ...
  assert.ok(s.wave === '3H59' || s.wave === '3H60' || s.wave === '3H61' || s.wave === '3H62' || s.wave === '3H63');
...
test('3H59-S-001 compose binds 3H59 tests and DeepSeek lock holds', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H59' || ad.adapterSnapshot().wave === '3H60' || ad.adapterSnapshot().wave === '3H61' || ad.adapterSnapshot().wave === '3H62' || ad.adapterSnapshot().wave === '3H63');
});
