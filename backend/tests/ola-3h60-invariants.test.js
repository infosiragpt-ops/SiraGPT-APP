...
test('3H60-L-001 adapter fail-open wires 3H60 helpers and wave', () => {
  ...
  assert.ok(s.wave === '3H60' || s.wave === '3H61' || s.wave === '3H62' || s.wave === '3H63' || s.wave === '3H64' || s.wave === '3H65' || s.wave === '3H66');
...
test('3H60-O-001 compose binds 3H60 tests and DeepSeek lock holds', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H60' || ad.adapterSnapshot().wave === '3H61' || ad.adapterSnapshot().wave === '3H62' || ad.adapterSnapshot().wave === '3H63' || ad.adapterSnapshot().wave === '3H64' || ad.adapterSnapshot().wave === '3H65' || ad.adapterSnapshot().wave === '3H66');
