...
test('3H41-AA-001 snapshot keeps 3H40 flags and wave 3H41 DeepSeek lock', () => {
  ...
  assert.ok(s.wave === '3H41' || s.wave === '3H42' || s.wave === '3H43' || s.wave === '3H44');
...
test('3H41-AE-001 compose binds 3H41 tests and wave is 3H41', () => {
  ...
  assert.ok(ad.adapterSnapshot().wave === '3H41' || ad.adapterSnapshot().wave === '3H42' || ad.adapterSnapshot().wave === '3H43' || ad.adapterSnapshot().wave === '3H44');
